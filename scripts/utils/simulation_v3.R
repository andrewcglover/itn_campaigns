...
par_net_region_sequential_v3 <- function(param_list) {
...
run_malsim_nets_sequential_v3 <- function(dataset,
                                          areas_included = NULL,
                                          N_reps = 100,
                                          N_cores = 0,
                                          areas_per_core = 1,
  ...
  if (use_hipercow) {
    ...
    par_output <- parLapply(cl, param_list, par_net_region_sequential_v3)
    comb_output <- do.call(rbind.data.frame, par_output)
    output_df <- rbind(output_df, comb_output)
    stopCluster(cl)
  }
